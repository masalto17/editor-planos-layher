...
const HORIZONTAL_CATS = new Set([
  'horizontalO', 'vigaPuente', 'horizontalU', 'horizontalUT14', 'plataforma', 'barandilla', 'rodapie',
...
export const ES_TIPO_VERTICAL = c => c === 'vertical' || c === 'base' || c === 'collarin' || c === 'apoyaTecho' || c === 'tacoMadera';
...
export const Z_ORDER = {
  ...
  tacoMadera: -0.5,
  vigaPuente: 4, horizontalU: 5, horizontalUT14: 5.1, stringer: 5.2,
...
export const DESPIECE_ORDER = {
  tacoMadera: -1, base: 0, collarin: 1, vertical: 2, horizontalO: 3, vigaPuente: 4, horizontalU: 5, horizontalUT14: 5.2,
