...
const appAccess={
  planos:{title:'Diseño de planos',description:'Organizá la estructura por vistas y filas. Consultá el despiece y abrí el plano actual con Ver en 3D.',href:'../editor.html',cta:'Abrir Layout ↗',route:'Planificá la estructura',notice:'Se abre en otra pestaña para conservar tu trabajo. Desde Layout podés crear piezas y enviar el plano al visualizador.'},
