...
## Estado actual: V1.3
Archivo principal: `src/LayherEditor.jsx` (migrado desde artifact de Claude.ai)
...
### Fase inmediata: V2.0
1. **Vista de planta sincronizada** — segunda vista que comparte el mismo modelo de datos
2. **Export a PDF** con membrete corporativo MásAlto/MYD, cuadro de datos, sellos legales
